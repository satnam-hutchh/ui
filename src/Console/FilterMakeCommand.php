...
class FilterMakeCommand extends GeneratorCommand
{
    ...
    {
        $stub = '/stubs/filters/filter.plain.stub';
    ...
    protected function buildClass($name)
    {
        ...
        $baseControllerExists = file_exists($this->getPath("{$rootNamespace}Filters\abstractFilter"));

        if ($baseControllerExists) {
            $replace["use {$filterNamespace}\abstractFilter;\n"] = '';
        } else {
            $replace[' extends abstractFilter'] = '';
            $replace["use {$rootNamespace}Filters\abstractFilter;\n"] = '';
        }
